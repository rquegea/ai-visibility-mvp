...
export default function SettingsPage() {
  ...
  const [apiKeys] = useState([
    { id: 1, name: 'Production API', key: 'sk-1234567890abcdef', created: '2024-01-01' },
    { id: 2, name: 'Development API', key: 'sk-abcdef1234567890', created: '2024-01-05' }
  ])
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <p className="text-sm text-muted-foreground">
                  Next billing date: February 7, 2024
                </p>
                <p className="text-sm text-muted-foreground">
                  Payment method: •••• •••• •••• 4242
                </p>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex justify-between items-center">
                <p className="text-sm text-muted-foreground">
                  Use these keys to access the AI Visibility API
                </p>
                <Button size="sm">
